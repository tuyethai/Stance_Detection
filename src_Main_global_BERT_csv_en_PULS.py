...
#     results_folder=data_folder+dataset_name+"_results/"    
...
#             continue
#         dict_pred = create_file_senti(dict_pred, file_name, lang)
...
#     eval_result_dict = metrics.classification_report(y_true, y_pred, output_dict=True)
#     write_dict(eval_result_dict, results_folder+"eval_result_dict.json")
